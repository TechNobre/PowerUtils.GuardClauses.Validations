...
namespace PowerUtils.Validations.GuardClauses
{
    ...
    public static class GuardValidationDoubleExtensions
    {
        /// <summary>
        ...
        public static double IfGreaterThan(
        ...
        public static double IfLessThan(
            this IGuardValidationClause _,
            double value,
            double min,
            [CallerArgumentExpression("value")] string parameterName = null
        ...
        public static double? IfDifferent(
            this IGuardValidationClause _,
            double? value,
            double otherValue,
            [CallerArgumentExpression("value")] string parameterName = null
